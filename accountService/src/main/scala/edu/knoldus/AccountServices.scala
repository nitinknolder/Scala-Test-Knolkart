...
class AccountServices (register: Map[Long, Registration] = Map ()) extends UserData {
  ...
  def servicesMenu (): Unit = {
    log.info ("Main Menu: \n")
    log.info ("\n 1: Registration \n 2: ViewAll Registered User \n 3: Exit \n")
    log.info ("Enter your Choice: \n")
    val choice = StdIn.readInt ()
    choice match {
      case 1 => registration
      // case 2 => val mob = StdIn.readLong()
      case 2 => viewAllUser
      case 3 => log.info ("Thanks For Using Knolkart")
      case _ => servicesMenu ()
    }
  }
  ...
  override def authenticateUser (phoneNumber: Long, password: String): Option[Registration] = {
  ...
  override def getRegisteredUsers: List[Registration] = {
    List[Registration](
